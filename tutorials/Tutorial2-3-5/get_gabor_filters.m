function filters = get_gabor_filters (rot, RF_siz, Div, Phi, sigma_factor)

% FUNCTION filters = get_gabor (rot, RF_siz, Div)
% 
% Computes and returns Gabor functions into 4-dim filters matrix.
...
for r = 1:num_rot
  ...
  filters(:,:,1,r) = f;  % the Gabors have only 1 input_plane (the image)
end
